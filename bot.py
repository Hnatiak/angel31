...
excluded_words = ['сука', 'стриптиз', 'секс', 'апарат', 'апаратура', 'аромат', 'кріт', 'абориген', 'аплодисменти', 'апокаліпсис', 'аркада', 'аркади', 'кірка', 'ящірка', 'турція', 'тінь'. 'аксесуар', 'анакондра', 'акорд', 'амілія', 'ярлик', 'шашлик', 'ананас', 'ренген', 'рись', 'павлін']
