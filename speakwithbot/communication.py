...
writeRandom = ["напиши будь яке число", "скажи будь яке число", "напиши будь яку цифру", "скажи будь яку цифру", "напиши будь-яке число", "скажи будь-яке число", "напиши будь-яку цифру", "скажи будь-яку цифру", "напиши рандомну цифру", "скажи рандомне число", "напиши рандомне число", "дай цифру", "дай число"]
...
# else
        ...
        for keyword in angel:
            ...
            #     answered_question = True
                ...
                bot.send_message(message.chat.id, 'Десь ' + str(random.randint(1, 10)) + ' разів на тиждень')
                answered_question = True
            elif text.startswith(f"{keyword} ") and 'скажи рандомне число' in text or text.startswith(f"{keyword} ") and 'напиши рандомне число' in text or text.startswith(f"{keyword} ") and 'напиши будь яке число' in text:
