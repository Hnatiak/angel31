...
whatareyoudoing = [ "що поробляєш", "що робиш", "чим займаєшся", "що поробляєш?", "що робиш?", "чим займаєшся?", "що ти робиш" ]
...
# else
        ...
        for keyword in angel:
            ...
            elif any(keyword in user_input for keyword in whatareyoudoing):
